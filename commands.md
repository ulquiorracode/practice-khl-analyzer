...
* **Пример для сезона 2017/18 (клуб «СКА»):**
    ...
    ```bash
    python khl_standings.py khl_2017_18.csv --task points_plot --team "СКА"
    ```

* **Пример для сезона 2015/16 (клуб «Салават Юлаев»):**

    ```bash
    python khl_standings.py khl_2015_16.csv --task points_plot --team "Салават Юлаев"
    ```
...
* **Пример для сезона 2017/18:**
    ...
    ```bash
    python khl_standings.py khl_2017_18.csv --task points_hist
    ```

* **Пример для сезона 2013/14:**

    ```bash
    python khl_standings.py khl_2013_14.csv --task points_hist
    ```
...
* **Пример для сезона 2017/18 (клуб «Ак Барс»):**
    ...
    ```bash
    python khl_standings.py khl_2017_18.csv --task diff_plot --team "Ак Барс"
    ```

* **Пример для сезона 2016/17 (клуб «Металлург Мг»):**

    ```bash
    python khl_standings.py khl_2016_17.csv --task diff_plot --team "Металлург Мг"
    ```
...
* **Пример для сезона 2017/18:**
    ...
    ```bash
    python khl_standings.py khl_2017_18.csv --task goals_hist
    ```

* **Пример для сезона 2014/15:**

    ```bash
    python khl_standings.py khl_2014_15.csv --task goals_hist
    ```
